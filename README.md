...
**Code:** `explore_Physionet_MI.ipynb` (to get the z-scored data), `decode_subj_1_rest_vs_task_comp_rnn_retrained_model.ipynb`
...
**Code:** `explore_Forenzo2023.ipynb`, `decode_Forenzo2023_real_vs_gen.ipynb`
